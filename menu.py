...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input("What item would you like to order from the menu? ")
            ...
            if menu_category.isdigit():
                ...
                if int(menu_category) in menu_items.keys():
                    ...
                    quantity = input("How many of the item selected would you like to order? ")
    ...
    while True:
        ...
        place_order = input("Would you like to keep ordering? (Y)es or (N)o ")

        # 5. Check the customer's input
        match place-order.lower():
            #Customer choose "Y"
            case 'y':
                # Keep ordering
                place_order = Y
...
for i in range(len(order)):
    ...
    num_item_spaces = 23 - len(item_name)
...
print (Your total cost for your order is: ${total: ,.2f})